...
__webpack_require__(/*! ./modules/polyfill */ "./src/assets/js/modules/polyfill.js");

__webpack_require__(/*! ./modules/useragent */ "./src/assets/js/modules/useragent.js");

__webpack_require__(/*! ./modules/smoothscroll */ "./src/assets/js/modules/smoothscroll.js");

__webpack_require__(/*! ./modules/site */ "./src/assets/js/modules/site.js");

__webpack_require__(/*! ./modules/animation */ "./src/assets/js/modules/animation.js");

__webpack_require__(/*! ./modules/svg-animation */ "./src/assets/js/modules/svg-animation.js");

__webpack_require__(/*! ./modules/menu */ "./src/assets/js/modules/menu.js");

__webpack_require__(/*! ./modules/slider */ "./src/assets/js/modules/slider.js");

__webpack_require__(/*! ./modules/countdown */ "./src/assets/js/modules/countdown.js");

__webpack_require__(/*! ./modules/parallax */ "./src/assets/js/modules/parallax.js");
...
var DATA_NAME = "data-countdown-";
var COUNTDOWN_DATE = DATA_NAME + "date";
...
function () {
  function Countdown(className) {
    ...
    this.$date = $('#' + this.className + '-date');
    this.$days = $('#' + this.className + '-days');
    this.$hours = $('#' + this.className + '-hours');
    this.$minutes = $('#' + this.className + '-minutes');
    this.$seconds = $('#' + this.className + '-seconds');

    if (this.$date.length) {
      this.datetime = Math.round(new Date(this.$date.attr(COUNTDOWN_DATE)).getTime() / 1000);
  ...
  _createClass(Countdown, [{
    ...
    value: function start() {
      ...
      distance = this.datetime - Math.round(new Date().getTime() / 1000);

      if (this.$days.length) {
        days = distance > 0 ? Math.floor(distance / 86400) : 0;
        this.$days.text(days);
      }

      if (this.$hours.length) {
        hours = distance > 0 ? Math.floor(distance % 86400 / 3600) : 0;
        this.$hours.text(hours);
      }

      if (this.$minutes.length) {
        minutes = distance > 0 ? Math.floor(distance % 3600 / 60) : 0;
        this.$minutes.text(minutes);
      }

      if (this.$seconds.length) {
        seconds = distance > 0 ? distance % 60 : 0;
...
var MENU_OPEN = DATA_NAME + "open";
var MENU_NAME = DATA_NAME + "name";
...
function () {
  function MenuTrigger($el, className) {
    ...
    var direction, background;
    this.$el = $el;
    this.className = className;
    this.controlName = this.$el.attr('aria-controls');
  ...
  _createClass(MenuTrigger, [{
    ...
    value: function show() {
      ...
      Object(body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["disableBodyScroll"])(document.querySelector('#' + this.controlName));
      $('body').attr((_$$attr = {}, _defineProperty(_$$attr, MENU_NAME, this.controlName), _defineProperty(_$$attr, MENU_OPEN, true), _$$attr));
    }
  }, {
    key: "hide",
    value: function hide() {
      ...
      Object(body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["enableBodyScroll"])(document.querySelector('#' + this.controlName));
      $('body').attr((_$$attr2 = {}, _defineProperty(_$$attr2, MENU_NAME, null), _defineProperty(_$$attr2, MENU_OPEN, false), _$$attr2));
    }
  }]);
...
var rellax = new rellax__WEBPACK_IMPORTED_MODULE_0___default.a('.js-parallax', {
  center: true,
  wrapper: null
});
...
/***/ "./src/assets/js/modules/polyfill.js":
/*!*******************************************!*\
  !*** ./src/assets/js/modules/polyfill.js ***!
  \*******************************************/
/*! no static exports found */
...
/* harmony import */ var swiper_dir_css_swiper_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper_dir/css/swiper.min.css */ "./node_modules/swiper/css/swiper.min.css");
...
/***/ "./src/assets/js/modules/svg-animation.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/svg-animation.js ***!
  \************************************************/
/*! no exports provided */
...
var vivusTarget;
vivusTarget = document.getElementsByClassName('js-vivus1');
setVivus(vivusTarget);

function setVivus(targets) {
  var option, vivusDuration;

  for (var i = 0; i < targets.length; i++) {
    option = generalOption;
    vivusDuration = targets[i].getAttribute('data-duration');

    if (vivusDuration) {
      option.duration = vivusDuration;
    }

    var targetClass = targets[i].getAttribute('class');

    if (targetClass.indexOf('tm-POA_FootSVG') === -1) {
      option.start = 'autostart';
    } else {
      option.start = 'inViewport';
    }

    new vivus__WEBPACK_IMPORTED_MODULE_0___default.a(targets[i], option, getChaineVivius);
  }
}

function getChaineVivius(myVivus) {
  var chainTargetClass, chainTargets;
  chainTargetClass = myVivus.el.getAttribute('data-chain');
  chainTargets = document.getElementsByClassName(chainTargetClass);
  setVivus(chainTargets);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserAgent; });
...
function () {
  ...
  _createClass(UserAgent, null, [{
    ...
    value: function setBrowser() {
      $('html').attr({
        'data-browser-name': platform__WEBPACK_IMPORTED_MODULE_0___default.a.name,
        'data-browser-version': platform__WEBPACK_IMPORTED_MODULE_0___default.a.version
      });
    }
  }, {
    key: "isMobile",
